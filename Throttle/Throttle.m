...
%% Throttle Guess
Target_thrust = min_throttle_pct*thrust_max;
converged = 0;
Pc_Max = 300;%[psi]
Pc_Min = 50;%[psi]
counter = 0;
Pc_throttle_guess = Pc_max * min_throttle_pct; %Inital guess[psi]
...
fuel_massflow_rate = mdot_guess/(1+OF)*2.20462;
ox_massflow_rate= mdot_guess*2.20462-fuel_massflow_rate;
